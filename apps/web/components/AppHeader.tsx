          ...
          <nav className="flex justify-between items-center mt-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="px-4 py-2 bg-transparent border border-gray-700 rounded-md text-gray-400 text-sm hover:border-[#667eea] hover:text-gray-200 transition-all cursor-pointer"
              >
                Sign Out
              </button>
            </div>
