          ...
          {showNavigation && (
            <nav className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <div className="flex gap-2 flex-wrap">
                <Link
                  href="/app"
                  className={`px-4 py-2 rounded-lg text-sm transition-all no-underline ${
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-transparent border border-gray-700 rounded-md text-sm text-gray-400 hover:border-[#667eea] hover:text-gray-200 transition-all cursor-pointer"
                >
                  Sign Out
                </button>
              </div>
